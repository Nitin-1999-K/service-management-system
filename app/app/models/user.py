...
class User(Base):
    ...
    ticket = relationship("Ticket", secondary = "ticket_raiser", back_populates="raised_by")

    assigned_allotment = relationship('TicketAllotment', foreign_keys='TicketAllotment.allocator_id', back_populates='allocator')
    received_allotment = relationship('TicketAllotment', foreign_keys='TicketAllotment.engineer_id', back_populates='engineer')

    def __init__(self, user_type, full_name, email, hashed_password, mobile_number, supervisor_id, db):
